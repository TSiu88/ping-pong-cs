# _[C# Ping Pong](https://github.com/TSiu88/ping-pong-cs)_

#### _Ping Pong Coding Exercise, 03.02.2020_

#### By _**Tiffany Siu and Adela Darmansyah**_

[![Project Status: Inactive – The project has reached a stable, usable state but is no longer being actively developed; support/maintenance will be provided as time allows.](https://www.repostatus.org/badges/latest/inactive.svg)](https://www.repostatus.org/#inactive)
![LastCommit](https://img.shields.io/github/last-commit/tsiu88/ping-pong-cs)
![Languages](https://img.shields.io/github/languages/top/tsiu88/ping-pong-cs)
...
This console application was written for Epicodus Intro to Programming and C#/React course.  It practices testing using MSTest for C# and replaces numbers divisible by certain values with the words ping, pong, or ping-pong.
...
2. Clone the [repository](https://github.com/TSiu88/ping-pong-cs.git) from my [GitHub page](https://github.com/TSiu88)
